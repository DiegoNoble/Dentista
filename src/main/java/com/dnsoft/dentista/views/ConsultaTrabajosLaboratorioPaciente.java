 ...
 * @author Diego Noble
 */
public final class ConsultaTrabajosLaboratorioPaciente extends InternalFrameEstandar {
    ...
    public ConsultaTrabajosLaboratorioPaciente(PlanTratamiento planTratamiento) {
        initComponents();
