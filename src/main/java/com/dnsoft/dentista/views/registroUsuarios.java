...
public class registroUsuarios extends javax.swing.JInternalFrame {
    ...
    private void buscaTodosLosRegistros() {
        ...
        listUsuarios.addAll(usuarioDAO.findAll());
    }
    ...
    private void muestraDetalles() {
        ...
        if (tblUsuarios.getSelectedRow() != -1) {
            ...
            cbPerfil.setSelectedItem(usuarioSeleccionado.getPerfilEnum().toString());
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            if (usuarioSeleccionado.getId() != null) {
                ...
                usuarioSeleccionado.setPerfilEnum((PerfilEnum) cbPerfil.getSelectedItem());
                usuarioDAO.saveAndFlush(usuarioSeleccionado);
