...
public class RestaurarBackupView extends java.awt.Frame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Seleccionar carpeta destino");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            backup_path.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
    ...
    private void tbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbGuardarActionPerformed
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    new BackupDB().restaurarBD(parametros.getMySql_Path(), parametros.getNombreBasesDatos(), txtBackupPath.getText(), txtLog);
