...
public class RubrosView extends javax.swing.JInternalFrame {

    List<Rubro> listMedios;
    IRubroDAO RubroDAO;
    DefaultTableModel tblModel;
    ListSelectionModel listModel;
    Rubro medioSeleccionado;
    Container container;
    ...
    private void buscaTodosLosRegistros() {
        ...
        listMedios.addAll(RubroDAO.findAll());
    }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            if (medioSeleccionado.getId() != null) {
                ...
                RubroDAO.saveAndFlush(medioSeleccionado);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            RubroDAO.delete(medioSeleccionado.getId());
