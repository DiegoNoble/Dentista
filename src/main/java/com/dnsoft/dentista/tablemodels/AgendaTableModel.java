...
public class AgendaTableModel extends AbstractTableModel {
    ...
    private final String[] colunas = new String[]{"Fecha", "Hora", "Paciente", "Situación"};
    ...
    public AgendaTableModel(List<Consulta> listConsultas) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                return c.getPaciente() + ", " + c.getComentario();
            case 3:
