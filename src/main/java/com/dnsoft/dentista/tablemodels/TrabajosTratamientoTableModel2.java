 ...
 * @author Diego Noble
 */
public class TrabajosTratamientoTableModel2 extends AbstractTableModel {
    ...
    public TrabajosTratamientoTableModel2(List<TrabajosTratamiento> list, JTextField txtTotal) {
        this.txtTotal = txtTotal;
        this.list = list;
    }

    public TrabajosTratamientoTableModel2(List<TrabajosTratamiento> list) {
        this.list = list;
    }

    public TrabajosTratamientoTableModel2() {
    }
