 ...
 * @author Diego Noble
 */
public class TrabajosProveedorTableModel extends AbstractTableModel {

    //nome da coluna da table
    private final String[] colunas = new String[]{"Fecha solicitud", "Fecha programada", "Fecha finalización", "Comentarios"};
    //lista para a manipulacao do objeto
    private List<TrabajosProveedor> listClasePacientess;

    public TrabajosProveedorTableModel() {
        listClasePacientess = new LinkedList<TrabajosProveedor>();
    }

    public TrabajosProveedorTableModel(List<TrabajosProveedor> listClasePacientess) {
